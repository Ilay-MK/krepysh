    ...
    */
    ...
    $('a[data-fancybox="cl-group"]').fancybox({
        ...
        caption: function (instance) {
            var advert = '<div class="ad"><div class="h5 text-uppercase text-center">Оставить заявку на пробное занятие</div><button type="button" class="btn btn-primary1 center-block" data-toggle="modal" data-target="#modalOrder" data-service="Галерея" role="button" onclick="$.fancybox.close();"><span>Оставить заявку</span></button></div>';
